...
if __name__ == '__main__':
    ...
    root = '/student/egk204/projects/clone-type-iv/src/models/astnn/data/'
    lang = 'gptcb'
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(model.state_dict(), root+lang+'/astnn_'+lang+'_'+str(epoch))
    ...
    res = str(now)+':     '+lang+' Precision: '+str(precision)+'  Recall: '+str(recall)+'  F1: '+str(f1) +'\n'
    
    f = open(f'results_astnn_{lang}.txt', 'a')
    f.write(res)
    f.close()
