...
parser.add_argument("--saved_model_path", default= '/home/egk204/PycharmProjects/clone-type-iv/src/models/gnn/saved_models/ggnnn_astandnext_bcb_9')
...
for mf in mutants_files:
    ...
    model=models.GGNN(vocablen=77535,embedding_dim=100,num_layers=num_layers,device=device).to(device)
...
r.to_csv('ggnn_mutation_results.csv', index=False, header=False)