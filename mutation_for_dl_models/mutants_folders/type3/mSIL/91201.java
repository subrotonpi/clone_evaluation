public static final String deriveCurveName (org.bouncycastle.jce.spec.ECParameterSpec ecParameterSpec) throws GeneralSecurityException {
    ...
    names.hasMoreElements ();) {
        ...
        if (params.getN ().equals (ecParameterSpec.getN ()) && params.getH ().equals (ecParameterSpec.getH ()) && params.getCurve ().equals (X1,ecParameterSpec.getCurve ()) && params.getG ().equals (ecParameterSpec.getG ())) {
