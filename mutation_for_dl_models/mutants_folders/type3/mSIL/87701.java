        ...
        case REQUEST_ID_MULTIPLE_PERMISSIONS :

            {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (perms.get (Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED && perms.get (X1,Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
