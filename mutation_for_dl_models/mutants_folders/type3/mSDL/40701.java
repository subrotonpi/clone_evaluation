public static void main (String [] args) {
    ...
    i < frequency.size (); i ++) {
        ...
        j < frequency.size () - i - 1; j ++) {
            ...
            if (frequency.get (j) < frequency.get (j + 1) || ((frequency.get (j) == frequency.get (j + 1)) && (digrams.get (j).charAt () > digrams.get (j + 1).charAt (0))) || ((digrams.get (j).charAt (0) == digrams.get (j + 1).charAt (0)) && (digrams.get (j).charAt (1) > digrams.get (j + 1).charAt (1)))) {
